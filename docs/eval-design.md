...
- Problem-book stats and rule verdicts fold into the plan read-only; events and the weekly Opportunity Check mark append only at finalize through projections and round-trip through `load_book`.
