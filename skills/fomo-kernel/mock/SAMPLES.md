...
|---|---|---|---|---|---|
| `sample_ai_holder.csv` | **AI 長期投資者** | 約 1.5 年(493–575 天) | 2023 起重押 AI 龍頭(NVDA/MSFT/GOOGL/AVGO/PLTR/TSM)、長抱、漲著順勢加碼、偶爾長抱後減碼 | **分散**(假分散:AI 暴險 100%、單一敘事);次要洞=NVDA 重倉 33% | 「你以為買 6 檔很分散,其實都押同一個 AI 敘事——一起漲一起跌,一次 AI 寒冬就是 −50%」 |
