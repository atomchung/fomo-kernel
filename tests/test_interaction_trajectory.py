...
SYNTHETIC_CHALLENGE = {
    "must_state": [
        ...
        {"topic": "rule_collision", "value": "new_breach",
         "anchor": "rule_collisions.rule-1.rule_effect",
         "detail": {"rule_id": "rule-1",
                    "text": "Single position must stay under a fifth of the book",
                    "state": "would_breach", "worsens": None}},
    ...
    "rule_effects": [
        {"rule_id": "rule-1",
         "text": "Single position must stay under a fifth of the book",
         "effect": "new_breach", "limit": 0.20, "limit_source": "user_cap",
